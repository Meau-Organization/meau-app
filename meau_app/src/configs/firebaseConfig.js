...
import { getDatabase, ref, child, get, set, query as queryReal, orderByKey, startAt, endAt, limitToLast, orderByChild } from "firebase/database";
...
export {
    ...
    addDoc, getDoc, setDoc, doc, collection, query, where, getDocs, updateDoc, realtime, ref, child, get, set, orderByKey, startAt, endAt, queryReal, limitToLast,
    orderByChild
};
